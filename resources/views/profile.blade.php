        ...
        <main class="page-content bg-light">
            ...
            <div class="container-fluid">
                <div class="layout-specing">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="bg-primary card border-0 shadow rounded overflow-hidden p-4" style="background: url('assets/images/account/bg.png') center;">
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-8">
                                        <div class="card text-center p-4 rounded">
                                            ...
                                            <ul class="list-unstyled social-icon social mb-0 mt-4">
                                                <li class="list-inline-item mb-0"><a href="javascript::void(0)" class="rounded"><i class="ti ti-brand-dribbble align-middle" title="dribbble"></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="javascript::void(0)" class="rounded"><i class="ti ti-brand-facebook align-middle" title="facebook"></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="javascript::void(0)" class="rounded"><i class="ti ti-brand-instagram align-middle" title="instagram"></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="javascript::void(0)" class="rounded"><i class="ti ti-brand-twitter align-middle" title="twitter"></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="javascript::void(0)" class="rounded"><i class="ti ti-mail align-middle" title="email"></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="javascript::void(0)" class="rounded"><i class="ti ti-world align-middle" title="website"></i></a></li>
                                            </ul><!--end icon-->
                    ...
                    <div class="row">
                        <div class="col-lg-6 mt-4 order-md-1 order-lg-2 order-1">
                            <div class="card border-0 shadow rounded p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="dropdown dropdown-primary">
                                        ...
                                        <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3">
                                            <a class="dropdown-item text-dark" href="#"><span class="mb-0 d-inline-block me-1"><i class="ti ti-settings"></i></span> Edit</a>
                                            <a class="dropdown-item text-dark" href="#"><span class="mb-0 d-inline-block me-1"><i class="ti ti-trash"></i></span> Delete</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/blog/bg1.jpg" class="img-fluid rounded" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="mt-4">
                                    <div class="post-meta d-flex justify-content-between">
                                        <ul class="list-unstyled mb-0">
                                            <li class="list-inline-item me-2 mb-0"><a href="javascript:void(0)" class="text-muted like"><i class="ti ti-heart me-1"></i>33</a></li>
                                            <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted comments"><i class="ti ti-message-circle me-1"></i>08</a></li>
                                        </ul>
                                        <a href="javascript:void(0)" class="text-muted"><i class="ti ti-share"></i></a>
                                    </div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="commentor-detail">
                                                        ...
                                                        <small class="text-muted">15th September, 2021 at 01:25 pm</small>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="commentor-detail">
                                                        ...
                                                        <small class="text-muted">15th September, 2021 at 05:44 pm</small>
                                                    </div>
                                                </div>
                                                <a href="#" class="text-muted"><i class="mdi mdi-reply"></i> Reply</a>
                                            </div>
                            ...
                            <div class="card border-0 shadow rounded p-4 mt-4">
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/blog/bg2.jpg" class="img-fluid rounded" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="card border-0 shadow rounded p-4 mt-4">
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/blog/bg3.jpg" class="img-fluid rounded" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="card border-0 rounded shadow p-4 mt-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-4">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h6 class="mb-0 text-dark">Calvin Carlo</h6>
                                            <small class="text-muted">Designer</small>
                                        </div>
                                    </a>

                                    <a href="profile.html" class="text-primary"><i class="ti ti-plus"></i></a>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-4">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h6 class="mb-0 text-dark">Nobita Kety</h6>
                                            <small class="text-muted">Designer</small>
                                        </div>
                                    </a>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-4">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h6 class="mb-0 text-dark">Nairobi Valy</h6>
                                            <small class="text-muted">Designer</small>
                                        </div>
                                    </a>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-4">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h6 class="mb-0 text-dark">Justin Lata</h6>
                                            <small class="text-muted">Designer</small>
                                        </div>
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-6 mt-4 order-md-2 order-lg-3 order-3">
                            <div class="card border-0 rounded shadow p-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="profile.html" class="text-primary"><i class="ti ti-arrow-right"></i></a>
                                </div>
                            ...
                            <div class="card border-0 rounded shadow p-4 widget mt-4">
                                ...
                                <div class="widget-grid overflow-hidden mt-3">
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/blog/travel/01.jpg" alt="img-missing" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/blog/travel/02.jpg" alt="img-missing" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/blog/travel/03.jpg" alt="img-missing" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/blog/travel/04.jpg" alt="img-missing" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/blog/travel/05.jpg" alt="img-missing" class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/blog/travel/06.jpg" alt="img-missing" class="img-fluid rounded">
                                        </a>
                                    </div>
                                </div>
                            </div>
