      ...
      <ul class="list-unstyled mb-0">
        ...
        <li class="list-inline-item mb-0 ms-1">
          <div class="dropdown dropdown-primary">
            <button
              type="button"
              class="btn btn-icon btn-soft-light dropdown-toggle p-0"
            ...
            <div
              class="dropdown-menu dd-menu shadow rounded border-0 mt-3 p-0"
              data-simplebar
              ...
              <div class="p-3">
                ...
                >
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-1">
                      <h6 class="mb-0 text-dark title">
                        <span class="fw-bold">One Refund Request</span>
                      </h6>
                ...
                >
                  <div class="d-flex align-items-center">
                    <img
                      src="{{ url('assets/images/client/15.jpg') }}"
                      class="avatar avatar-md-sm rounded-circle border shadow me-2"
                      alt=""
                    />
                    <div class="flex-1">
                      <h6 class="mb-0 text-dark title">
                        <span class="fw-bold">Cally</span> started
                        following you
                      </h6>
        ...
        <li class="list-inline-item mb-0 ms-1">
          <div class="dropdown dropdown-primary">
            ...
            >
              <img
                src="{{ url('assets/images/client/05.jpg') }}"
            ...
            >
              ...
              <!-- <a class="dropdown-item text-dark" href="profile.html"
                  ...
                  Profile</a
                > -->
              <!-- <a class="dropdown-item text-dark" href="email.html"
                  ><span class="mb-0 d-inline-block me-1"
