            ...
            <table class="table table-center bg-white mb-0">
                ...
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $dosen->nama }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $dosen->nip }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                    ...
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $dosen->prodi->nama_prodi }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $dosen->bidangilmu->nama }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                        <div
                        class="d-flex badge
                        @if ($dosen->status != null)
                            bg-soft-success
                        @else
                            bg-soft-danger
                        @endif px-3 py-1"
...
<div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-body p-3 pt-4">
        ...
        <form method="POST" action="dosen/posts">
            @csrf
            <div class="row">
            <div class="col-12">
                <div class="mb-3">
            ...
            <div class="col-12">
                ...
                <input
                    ...
                    class="form-control"
                />
                <p class="text-danger">Minimal 8 character</p>
                </div>
            </div>
            </div>
            <div class="row">
            <div class="col-12">
                <div class="mb-3" id="konfirmpasswordDiv">
                <label class="form-label"
                    >Konfirm Password
            ...
            <div class="col-12">
                ...
                <label class="form-label"
                    ...
                    <span class="text-danger">*</span></label
                >
                <select required class="form-control" name="bidangilmu_id">
                    <option selected>--Pilih Bidang Ilmu--</option>
                    @foreach($bidangilmu as $key)
