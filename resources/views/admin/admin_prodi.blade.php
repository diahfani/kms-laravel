            ...
            <table class="table table-center bg-white mb-0">
                ...
                <!-- Start -->
                    ...
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $tu->nama }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $tu->nip }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                    ...
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $tu->prodi->nama_prodi }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $tu->fakultas->nama }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                        <div
...
<div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-header border-bottom p-3">
        <h5 class="modal-title" id="tambahmodel">Formulir Tata Usaha</h5>
        <button
        type="button"
    ...
    <div class="modal-body p-3 pt-4">
        ...
        <form method="post" action="admin-prodi/posts">
            @csrf
            <div class="row">
            <div class="col-12">
                <div class="mb-3">
