            ...
            <table class="table table-center bg-white mb-0">
                ...
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $mahasiswa->nama }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $mahasiswa->npm }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                    ...
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $mahasiswa->tahun_masuk }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="ms-2">{{ $mahasiswa->prodi->nama_prodi }}</span>
                    </div>
                    </td>
                    <td class="p-3">
                        <div
                        ...
                        >
                        <span>@if ($mahasiswa->status == 'Aktif')
                            Aktif
                            @else
                            Tidak Aktif
                        @endif</span>
...
<div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-body p-3 pt-4">
        ...
        <form method="POST" action="mahasiswa/posts">
            @csrf
            <div class="row">
            <div class="col-12">
                <div class="mb-3">
